...
if($set->num_rows > 0) {
    ...
    echo "<script>alert('피자몰 로그인 성공하였습니다.');</script>"; # 박스 팝업으로 하나뜸 - alert
    echo "<script>location.replace('index.php')</script>"; # alert랑 세트, 방법2 .. + href보다 replace방법을 더 선호함

}
else {
    # echo "로그인 실패";
    echo "<script>alert('피자몰 로그인 실패하였습니다.');</script>"; # 박스 팝업으로 하나뜸 - alert
    echo "<script>location.replace('signin.html')</script>"; # alert랑 세트, 방법2 .. + href보다 replace방법을 더 선호함   
}
?>